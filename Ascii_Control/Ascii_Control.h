/*
  ascii.h - Library for easy handle ascii code to a led matrix
  Created by Isaac Montero, Jan 2017.
  Additional information are available
  Released into the public domain.
*/

#ifndef Ascii_Control_h
#define Ascii_Control_h
...
public:
	Ascii_Control();
	byte * LoadFont(int Ccode);
	// Declare and Initialize the font array data 
	const byte Font1[32][7] = { 
